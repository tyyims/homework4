...
# Filter the data to remove SNPs, 800-series plans, and prescription drug only plans
filtered_data <- final.data %>%
  filter(!(plan_type == "SNP" | grepl("^800", planid) | partd))

# Group the data by county and year and count the number of plans in each group
